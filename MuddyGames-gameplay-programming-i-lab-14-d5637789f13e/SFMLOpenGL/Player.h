...
const int VERTICES_PLAYER = 24;	// Total Number of Vertices
const int INDICES_PLAYER	= 12;	// Total Number of Indexes
const int UVS_PLAYER		= 48;	// Total Number of UVs
const int COLORS_PLAYER	= 24;	// Total Number of Colors
